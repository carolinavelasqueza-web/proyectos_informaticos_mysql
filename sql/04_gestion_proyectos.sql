...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-09-2025 a las 22:26:57
...
CREATE TABLE `copia_actualizados_tablauu` (
  ...
  `operacion_tiempo` timestamp NOT NULL DEFAULT current_timestamp(),
  `datos_antiguos` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`datos_antiguos`)),
  `nuevos_datos` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`nuevos_datos`))
...
INSERT INTO `copia_actualizados_tablauu` (`id`, `tabla_origen`, `operacion`, `operacion_tiempo`, `datos_antiguos`, `nuevos_datos`) VALUES
...
INSERT INTO `copia_eliminados_tabladd` (`id`, `tabla_origen`, `operacion`, `operacion_tiempo`, `data_eliminado`) VALUES
...
CREATE TRIGGER `tr_actualiza_docente` AFTER UPDATE ON `docente` FOR EACH ROW BEGIN
    INSERT INTO copia_actualizados_tablaUU (tabla_origen, operacion, datos_antiguos, nuevos_datos)
    VALUES (
        'DOCENTE',
        'UPDATE',
